...
})(StreamCategory = exports.StreamCategory || (exports.StreamCategory = {}));
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/" + utils_1.generateRandomSuffix(), config.loadPage)];
                case 1:
                    $ = _c.apply(void 0, [_d.sent()]);
                    return [4 /*yield*/, Promise.all($('a.col-box.streamer')
                            .toArray()
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        category = el.children().first().attr('title');
                                        country = {
                                        ...
                                        viewers = el.contents().last().numFromText();
                                        hltvLink = el.attr('href');
                                        stream = { name: name, category: category, country: country, viewers: viewers, hltvLink: hltvLink };
                                        if (!loadLinks) return [3 /*break*/, 2];
                                        return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/" + hltvLink, config.loadPage)];
                                    case 1:
                                        $streamPage = _a.sent();
                                        realLink = $streamPage('iframe').attr('src');
                                        return [2 /*return*/, __assign(__assign({}, stream), { realLink: realLink })];
