...
})(TeamPlayerType = exports.TeamPlayerType || (exports.TeamPlayerType = {}));
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/team/" + id + "/" + utils_1.generateRandomSuffix(), config.loadPage)];
                case 1:
                    ...
                    rank = utils_1.parseNumber($('.profile-team-stat .right').first().text().replace('#', ''));
                    players = (_c = $('.players-table tbody tr')
                        ...
                        name: el
                            ...
                            .text(),
                        id: el.find('.playersBox-playernick-image').attrThen('href', utils_1.getIdAt(2)),
                        ...
                        ? [
                            {
                                id: $('.coach-table .playersBox-playernick-image').attrThen('href', utils_1.getIdAt(2)),
                    ...
                    try {
                        ...
                        rankingDevelopment = rankings.dataSource.dataset[0].data.map(function (x) {
                            return utils_1.parseNumber(x.value);
                        });
                    }
                    catch (_e) {
                        rankingDevelopment = [];
