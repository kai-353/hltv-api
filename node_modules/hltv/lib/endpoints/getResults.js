...
var getResults = function (config) { return function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var query, page, $, results, _loop_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                query = querystring_1.stringify(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (options.startDate ? { startDate: options.startDate } : {})), (options.endDate ? { endDate: options.endDate } : {})), (options.matchType ? { matchType: options.matchType } : {})), (options.rankingFilter ? { rankingFilter: options.rankingFilter } : {})), (options.maps ? { map: options.maps.map(GameMap_1.toMapFilter) } : {})), (options.bestOfX ? { bestOfX: options.bestOfX } : {})), (options.countries ? { country: options.countries } : {})), (options.contentFilters ? { content: options.contentFilters } : {})), (options.eventIds ? { event: options.eventIds } : {})), (options.playerIds ? { player: options.playerIds } : {})), (options.teamIds ? { team: options.teamIds } : {})), (options.game ? { gameType: options.game } : {})));
                page = 0;
                results = [];
                _loop_1 = function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, utils_1.sleep((_a = options.delayBetweenPageRequests) !== null && _a !== void 0 ? _a : 0)];
                            case 1:
                                _d.sent();
                                _c = scraper_1.HLTVScraper;
                                return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/results?" + query + "&offset=" + page * 100, config.loadPage)];
                            case 2:
                                $ = _c.apply(void 0, [_d.sent()]);
                                page++;
                                featuredResults = $('.big-results .result-con')
                                    .toArray()
                                    .map(function (el) { return el.children().first().attrThen('href', utils_1.getIdAt(2)); });
                                results.push.apply(results, $('.result-con')
                                    .toArray()
                                    .map(function (el) {
                                    var id = el.children().first().attrThen('href', utils_1.getIdAt(2));
                                    ...
                                    return __assign({ id: id,
                                        ...
                                        date: date,
                                        team1: team1,
                                        team2: team2, result: { team1: team1Result, team2: team2Result } }, (format.includes('bo')
                                        ? { format: format }
                                        : { map: GameMap_1.fromMapSlug(format), format: 'bo1' }));
                                })
