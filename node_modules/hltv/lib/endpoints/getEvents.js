...
var getEvents = function (config) { return function (options) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/events?" + query, config.loadPage)];
                case 1:
                    ...
                    bigUpcomingEvents = $('a.big-event')
                        ...
                        var prizePool = el
                            ...
                            .eq(1)
                            .text();
                        var numberOfTeams = utils_1.parseNumber(el.find('.additional-info tr').first().find('td').eq(2).text());
                        return {
                            id: id,
                            name: name,
                            dateStart: dateStart,
                    ...
                    smallUpcomingEvents = $('a.small-event')
                        ...
                        var numberOfTeams = utils_1.parseNumber(el.find('.prizePoolEllipsis').prev().text());
                        return {
                            id: id,
                            name: name,
                            dateStart: dateStart,
