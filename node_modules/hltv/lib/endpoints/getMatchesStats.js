...
var getMatchesStats = function (config) { return function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/stats/matches?" + query + "&offset=" + page * 50, config.loadPage)];
            case 3:
                ...
                matches.push.apply(matches, $('.matches-table tbody tr')
                    ...
                    var map = GameMap_1.fromMapSlug(el.find('.dynamic-map-name-short').text());
                    var team1 = {
                        id: el.find('.team-col a').first().attrThen('href', utils_1.getIdAt(3)),
                        name: el.find('.team-col a').first().text()
                    };
                    var team2 = {
                        id: el.find('.team-col a').last().attrThen('href', utils_1.getIdAt(3)),
