...
exports.getEventByName = void 0;
var getEvent_1 = require("./getEvent");
var getEventByName = function (config) { return function (_a) {
    var name = _a.name;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, getEvent_1.getEvent(config)({ id: firstResult.id })];
            }
        });
    });
}; };
