        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/ranking/teams/" + (year !== null && year !== void 0 ? year : '') + "/" + (month !== null && month !== void 0 ? month : '') + "/" + (day !== null && day !== void 0 ? day : ''), config.loadPage)];
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/" + countryRankingLink, config.loadPage)];
                case 2:
                ...
                case 3:
                    teams = $('.ranked-team')
                        ...
                        var team = {
                            ...
                            id: el.find('.moreLink').attrThen('href', utils_1.getIdAt(2))
                        };
