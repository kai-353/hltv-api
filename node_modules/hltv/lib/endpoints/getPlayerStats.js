...
var getPlayerStats = function (config) { return function (options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all([
                        utils_1.fetchPage("https://www.hltv.org/stats/players/" + options.id + "/" + utils_1.generateRandomSuffix() + "?" + query, config.loadPage).then(scraper_1.HLTVScraper),
                        utils_1.fetchPage("https://www.hltv.org/stats/players/individual/" + options.id + "/" + utils_1.generateRandomSuffix() + "?" + query, config.loadPage).then(scraper_1.HLTVScraper),
                        utils_1.fetchPage("https://www.hltv.org/stats/players/matches/" + options.id + "/" + utils_1.generateRandomSuffix() + "?" + query, config.loadPage).then(scraper_1.HLTVScraper)
                    ])];
            case 1:
                ...
                image = imageUrl.includes('bodyshot/unknown.png') ? undefined : imageUrl;
                age = $('.summaryPlayerAge').textThen(function (x) {
                    return utils_1.parseNumber(x.split(' ')[0]);
                });
                country = {
                ...
                team = $('.SummaryTeamname').text() !== 'No team'
                    ? {
                        ...
                        id: $('.SummaryTeamname a').attrThen('href', utils_1.getIdAt(3))
                    }
                    : undefined;
                ...
                matches = m$('.stats-table tbody tr')
                    ...
                    return {
                        mapStatsId: el
                            ...
                            .first()
                            .find('a')
                            .attrThen('href', utils_1.getIdAt(4)),
                        ...
                        team1: {
                            id: el
                                ...
                                .attrThen('href', utils_1.getIdAt(3)),
                        ...
                        map: GameMap_1.fromMapSlug(el.find('.statsMapPlayed').text()),
                        kills: kills,
                        deaths: deaths,
