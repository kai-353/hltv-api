...
var getPlayer = function (config) { return function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var $, _b, isRegularPlayer, nameText, name, ign, imageUrl, image, age, twitter, twitch, facebook, instagram, country, hasTeam, team, getMapStat, statistics, achievements, teams, news;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = scraper_1.HLTVScraper;
                    return [4 /*yield*/, utils_1.fetchPage("https://www.hltv.org/player/" + id + "/" + utils_1.generateRandomSuffix(), config.loadPage)];
                case 1:
                    $ = _b.apply(void 0, [_c.sent()]);
                    isRegularPlayer = $('.standard-box.profileTopBox').exists();
                    nameText = isRegularPlayer
                    ...
                    age = isRegularPlayer
                        ? $('.profile-player-stat-value')
                            .first()
                            .textThen(function (x) { return utils_1.parseNumber(x.split(' ')[0]); })
                        : $('.playerAge .listRight').textThen(function (x) { return utils_1.parseNumber(x.split(' ')[0]); });
                    ...
                    country = isRegularPlayer
                        ? {
                            name: $('.player-realname .flag').attr('alt'),
                            code: $('.player-realname .flag').attrThen('src', function (x) { var _a; return (_a = x.split('/').pop()) === null || _a === void 0 ? void 0 : _a.split('.')[0]; })
                        }
                        : {
                    ...
                    if (hasTeam) {
                        if (isRegularPlayer) {
                            team = {
                                ...
                                id: $('.profile-player-stat-value a').attrThen('href', utils_1.getIdAt(2))
                            };
                        }
                        else {
                            team = {
                                name: $('.playerTeam a').trimText(),
                                id: $('.playerTeam a').attrThen('href', utils_1.getIdAt(2))
                            };
                        }
                    }
                    ...
                    achievements = $('.achievement-table .team')
                        ...
                        event: {
                            ...
                            id: el.find('.tournament-name-cell a').attrThen('href', utils_1.getIdAt(2))
                        }
                    }); });
                    teams = $('.team-breakdown .team')
                        .toArray()
                        .map(function (el) { return ({
                        id: el.find('.team-name-cell a').attrThen('href', utils_1.getIdAt(2)),
                        ...
                        trophies: el
                            ...
                            id: trophyEl.attrThen('href', utils_1.getIdAt(2)),
